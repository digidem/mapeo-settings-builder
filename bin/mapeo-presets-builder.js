...
function build () {
  ...
  var genSVGs = require('../scripts/build_svgs.js').genSVGs
  var genSprites = require('../scripts/build_sprites.js').genSprites
  var genPackage = require('../scripts/build.js').genPackage
